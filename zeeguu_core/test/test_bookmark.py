...
from zeeguu_core.test.model_test_mixin import ModelTestMixIn

from zeeguu_core.test.rules.bookmark_rule import BookmarkRule
from zeeguu_core.test.rules.exercise_rule import ExerciseRule
from zeeguu_core.test.rules.outcome_rule import OutcomeRule
from zeeguu_core.test.rules.source_rule import SourceRule
from zeeguu_core.test.rules.text_rule import TextRule
from zeeguu_core.test.rules.user_rule import UserRule
