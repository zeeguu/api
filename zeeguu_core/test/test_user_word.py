...
class UserWordTest(ModelTestMixIn):
    ...
    def test_find(self):
        ...
        user_word_to_check = UserWord.find(user_word_should_be.word, user_word_should_be.language)
    ...
    def test_find_all(self):
        list_random_user_words = [UserWordRule().user_word for _ in range(random.randint(2, 5))]
