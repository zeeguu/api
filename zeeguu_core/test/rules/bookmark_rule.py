...
from zeeguu_core.bookmark_quality import quality_bookmark, bad_quality_bookmark
from zeeguu_core.test.rules.base_rule import BaseRule
from zeeguu_core.test.rules.language_rule import LanguageRule
from zeeguu_core.test.rules.user_word_rule import UserWordRule
...
class BookmarkRule(BaseRule):
    ...
    def _create_model_object(self, user, force_quality=True, **kwargs):
        ...
        while not bookmark:
            ...
            from zeeguu_core.test.rules.article_rule import ArticleRule
