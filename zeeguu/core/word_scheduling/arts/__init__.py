...
from zeeguu.core.word_scheduling.arts.experiments.arts_diff_fast import ArtsDiffFast
from zeeguu.core.word_scheduling.arts.experiments.arts_random import ArtsRandom
