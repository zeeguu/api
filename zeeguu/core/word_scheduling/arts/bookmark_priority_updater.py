...
from zeeguu.core.model.learner_stats.exercise_stats import ExerciseStats
...
from zeeguu.core.word_scheduling.arts.analysis.normal_distribution import NormalDistribution
...
class BookmarkPriorityUpdater:
    ...
    def update_bookmark_priority(cls, db, user):
        ...
        try:
            ...
            zeeguu.core.log(f"{fit_for_study_count} bookmarks fit for study")
