...
class VoiceSynthesizer:
    ...
    def get_voice_config(self, voice_type: str, language_code: str, teacher_language: str = None, variety: str = None) -> dict:
        ...
        Args:
            ...
            variety: Optional ISO 3166-1 alpha-2 country of the learner's variety.
                Applies only to the voices speaking the language being LEARNED;
                the teacher speaks the learner's own language, where a variety of
                the target language means nothing.
        """
    ...
    def synthesize_segment(
        self, text: str, voice_type: str, language_code: str, speaking_rate: float = 1.0, teacher_language: str = None, variety: str = None
    ) -> str:
        """
        ...
        """
        voice_config = self.get_voice_config(voice_type, language_code, teacher_language, variety)
    ...
    def _synthesize_script_to_file(self, script, output_path, language_code, teacher_language_code, cefr_level=None, on_progress=None, variety=None):
        ...
        for voice_type, text, silence_duration in segments:
            if voice_type == "silence":
                ...
                audio_path = self.synthesize_segment(
                    text, voice_type, language_code, rate, teacher_language_code, variety
                )
    ...
    def generate_lesson_audio(self, audio_lesson_meaning_id, teacher_language_code, script, language_code, cefr_level=None, on_progress=None, variety=None):
        ...
        return self._synthesize_script_to_file(script, output_path, language_code, teacher_language_code, cefr_level, on_progress, variety)

    def generate_dialogue_audio(self, dialogue_id, teacher_language_code, script, language_code, cefr_level=None, on_progress=None, variety=None):
