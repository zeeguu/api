select b.id bookmark_id, b.starred , uw.word, tw.word , uw.rank , b.learned , b.fit_for_study , b.learned_time, bss.id 
from bookmark b
...
order by b.starred desc, uw.rank is null, uw.rank asc
