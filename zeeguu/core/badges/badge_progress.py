from zeeguu.core.model.activity_type import ActivityTypeMetric, ActivityType
...
def increment_badge_progress(db_session, metric: ActivityTypeMetric, user_id: int, increment_value: int = 1) \
        -> list[UserBadge]:
    """
...
def update_badge_progress(db_session, metric: ActivityTypeMetric, user_id: int, current_value: int) \
        -> list[UserBadge]:
    """
