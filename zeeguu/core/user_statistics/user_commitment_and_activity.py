...
def activity_and_commitment_by_user(user):
	return{ "user_minutes": convert_to_date_seconds(commitment_mins(user)),
					"user_days": convert_to_date_seconds(commitment_days(user)),
					"consecutive_weeks": convert_to_date_seconds(commitment_consecutive_weeks(user)),
